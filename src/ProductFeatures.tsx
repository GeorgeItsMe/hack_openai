...
export function ExtensionDetails({ onDemo }: { onDemo: () => void }) {
  return <>
    ...
    <a className="button button-dark" href="https://github.com/GeorgeItsMe/hack_openai#расширение-и-локальный-сервер" target="_blank" rel="noreferrer">Get the extension & setup steps <ArrowUpRight size={17} /></a><button className="extension-demo-link" onClick={onDemo}>Or try the no-install preview <ArrowRight size={14} /></button>
  </>;
}
