    ...
    <div className={`workspace ${expanded ? 'workspace-expanded' : ''}`}>
      ...
      <div className="workspace-inner">
        <aside className="workspace-sidebar">
          <a className="workspace-brand" href="#" onClick={e => { e.preventDefault(); changeView('overview'); }} aria-label="Tabby workspace home"><Cat size={29} variant="workspace" /> tabby<span>✳</span></a>
          ...
          <div className="sidebar-bottom"><Cat size={40} variant="sidebar" /><p>Big ideas need<br />a little headspace.</p><span>Make yourself at home.</span></div>
